...
int64_t v;
  int _m1_ret = 0;
  _m1_ret = (v = std_vector__new(), std_vector__push(v, 10), (std_vector__push(v, 20), (std_vector__push(v, 30), (std_vector__push(v, 40), (std_vector__push(v, 50), (main__say(main__int_to_string(std_vector__length(v))), (main__say(main__int_to_string(std_vector__get(v, 2))), (main__say(main__int_to_string(std_vector__contains(v, 30))), (main__say(main__int_to_string(std_vector__contains(v, 99))), (main__say(main__int_to_string(std_vector__index_of(v, 40))), (main__say(main__int_to_string(std_vector__sum(v))), (main__say(main__int_to_string(std_vector__max(v))), (main__say(main__int_to_string(std_vector__min(v))), (std_vector__reverse(v), (main__say(std_vector__to_string(v)), 0)))))))))))))));
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
