...
char* a;
  int _m1_ret = 0;
  _m1_ret = (a = std_string__concat("hello", " world"), main__say(a), (main__say(main__int_to_string(std_string__length(a))), (main__say(main__int_to_string(std_string__equals("hello world", a))), (main__say(main__int_to_string(std_string__starts_with(a, "hello"))), (main__say(main__int_to_string(std_string__ends_with(a, "world"))), (main__say(main__int_to_string(std_string__contains(a, "lo w"))), (main__say(main__int_to_string(std_string__contains(a, "xyz"))), (main__say(main__int_to_string(std_string__to_int("42"))), (main__say(std_string__from_int(99)), 0)))))))));
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
