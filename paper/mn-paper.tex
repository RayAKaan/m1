...
Mn to C: a 4,923-line C frontend~(M0) compiles the self-hosted compiler~(M1), which emits C
...
specifications---miss. The M1 compiler comprises 6,848 lines of M0 source and passes
46~of~73~test programs, including all 13 temporal-operator tests.
\end{abstract}
...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
  ...
  \item A bootstrapped two-tier compiler of 6,848 lines of M0 source generates C code with
    integrated runtime temporal monitors, passing 46 of 73 test programs, including all 13 temporal-operator tests (\cref{sec:impl}).
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  \item \textbf{M0 (the bootstrap):} 4,923 lines of C implementing a subset of Mn without
    temporal keywords.
  \item \textbf{M1 (the generated compiler):} 6,848 lines of M0 source (15 files) implementing
    the full Mn language. M0 compiles M1's source to produce the \texttt{m1c} binary.
  \item \textbf{Runtime library:} 512 lines of C providing memory management, string
...
\midrule
M0 bootstrap compiler    & C  & 23 & 4,923\\
Runtime library          & C  &  1 &   512\\
M1 self-hosted compiler  & M0 & 15 & 6,848\\
M1 generated C output    & C  &  1 & 3,273\\
Phase Graph module       & C  &  2 &   420\\
Test programs            & Mn & 73 &   747\\
\midrule
...
The Mn test suite comprises 73 programs across seven categories:
...
compiler of 6,848 lines of M0 source demonstrates the approach is practical, and 46 of 73 test
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  \item \textbf{M0} (complete): Bootstrap compiler in C. 4,923 lines.
  \item \textbf{M1} (complete): Self-hosted compiler with five temporal keywords. 6,848 lines
    of M0 source.
