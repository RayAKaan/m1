...
int64_t TK_MODULE_DECL = 65;
int64_t TK_IMPORT = 66;
...
static inline M1Tk TkFor() {
  M1Tk v = { .tag = M1Tk_TkFor, .data = {0} };
  return v;
}
...
static inline M1Tk TkWas() {
  M1Tk v = { .tag = M1Tk_TkWas, .data = {0} };
  return v;
}
...
static inline M1Tk TkReturn() {
  M1Tk v = { .tag = M1Tk_TkReturn, .data = {0} };
  return v;
}
static inline M1Tk TkBreak() {
  M1Tk v = { .tag = M1Tk_TkBreak, .data = {0} };
  return v;
}
static inline M1Tk TkContinue() {
  M1Tk v = { .tag = M1Tk_TkContinue, .data = {0} };
  return v;
}
static inline M1Tk TkModuleDecl() {
  M1Tk v = { .tag = M1Tk_TkModuleDecl, .data = {0} };
  return v;
}
static inline M1Tk TkImport() {
  M1Tk v = { .tag = M1Tk_TkImport, .data = {0} };
  return v;
}
static inline M1Tk TkLinear() {
  M1Tk v = { .tag = M1Tk_TkLinear, .data = {0} };
  return v;
}
static inline M1Tk TkAffine() {
  M1Tk v = { .tag = M1Tk_TkAffine, .data = {0} };
  return v;
}
static inline M1Tk TkPersistent() {
  M1Tk v = { .tag = M1Tk_TkPersistent, .data = {0} };
  return v;
}
static inline M1Tk TkEventual() {
  M1Tk v = { .tag = M1Tk_TkEventual, .data = {0} };
  return v;
}
...
(m0_string_eq(s, "exists") == 1) {                            
                            return mk_tok(TkExists(), line, col);                          
                                                        ...
                                                        if 
(m0_string_eq(s, "Linear") == 1) {                              
                              return mk_tok(TkLinear(), line, col);                            
                            } else {                              
                                                            if 
(m0_string_eq(s, "Affine") == 1) {                                
                                return mk_tok(TkAffine(), line, col);                              
                              } else {                                
                                                                if 
(m0_string_eq(s, "Persistent") == 1) {                                  
                                  return mk_tok(TkPersistent(), line, col);                                
                                } else {                                  
                                                                    if 
(m0_string_eq(s, "Eventual") == 1) {                                    
                                    return mk_tok(TkEventual(), line, col);                                  
                                  } else {                                    
                                                                        if 
...
(m0_string_eq(s, "while") == 1) {                                        
                                         return mk_tok(TkWhile(), line, col);                                      
                                          ...
                                          if 
(m0_string_eq(s, "for") == 1) {                                        
                                             return mk_tok(TkFor(), line, col);                                      
                                           } else {                                        
                                             if 
...
(m0_string_eq(s, "then") == 1) {
 ...
 (m0_string_eq(s, "will") == 1) {
                                                  ...
                                                  if
  (m0_string_eq(s, "return") == 1) {
                                                  return mk_tok(TkReturn(), line, col);
                                                } else {
                                                  if
  (m0_string_eq(s, "break") == 1) {
                                                  return mk_tok(TkBreak(), line, col);
                                                } else {
                                                  if
  (m0_string_eq(s, "continue") == 1) {
                                                  return mk_tok(TkContinue(), line, col);
                                                } else {
                                                  if
  (m0_string_eq(s, "module") == 1) {
                                                  return mk_tok(TkModuleDecl(), line, col);
                                                } else {
                                                  if
  (m0_string_eq(s, "import") == 1) {
                                                  return mk_tok(TkImport(), line, col);
                                                } else {
...
m0_substr((l).src, start, (l).pos);    (void)s;
    if 
(m0_string_eq(s, "fn") == 1) {      
      return (M1LexResult){mk_tok(TkFn(), line, col), l};    
    } else {      
    if 
...
k.tag) {      case M1Tk_TkEof: {
      ...
      case M1Tk_TkPersistent: {
        return "PERSISTENT";      
      }
      case M1Tk_TkEventual: {
        return "EVENTUAL";      
      }
      case M1Tk_TkModuleDecl: {
        return "MODULE_DECL";      
      }
      case M1Tk_TkImport: {
        return "IMPORT";      
