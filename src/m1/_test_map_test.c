...
int64_t _;
  int _m1_ret = 0;
  _m1_ret = (m = map_new(), _ = map_set(m, 2, 100), _ = map_set(m, 7, 200), _ = map_set(m, 11, 300), _ = map_set(m, 15, 400), _ = say(int_to_string(map_get(m, 2))), _ = say(int_to_string(map_get(m, 7))), _ = say(int_to_string(map_get(m, 11))), _ = say(int_to_string(map_get(m, 15))), _ = say(int_to_string(map_len(m))), 0);
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
