...
int64_t build_map(int64_t nums) {
int64_t _will_0=0,_will_1=0,_will_2=0,_will_3=0,_will_4=0,_will_5=0,_will_6=0,_will_7=0,_will_8=0,_will_9=0;
int64_t m;
int64_t i;
int64_t _;
  int64_t _m1_ret = 0;
  _m1_ret = (m = map_new(), i = 0, _ = ({ while ((i < vector_len(nums))) { _ = map_set(m, vector_get(nums, i), i), ({ (i = (i + 1)); i; }); } 0; }), m);
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
int64_t find_match(int64_t nums, int64_t m, int64_t target, int64_t i) {
int64_t _will_0=0,_will_1=0,_will_2=0,_will_3=0,_will_4=0,_will_5=0,_will_6=0,_will_7=0,_will_8=0,_will_9=0;
  int64_t _m1_ret = 0;
  _m1_ret = (map_get(m, (target - vector_get(nums, i))));
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
...
int64_t idx;
  int _m1_ret = 0;
  _m1_ret = (nums = vector_new(), _ = vector_push(nums, 2), _ = vector_push(nums, 7), _ = vector_push(nums, 11), _ = vector_push(nums, 15), m = build_map(nums), idx = find_match(nums, m, 9, 0), say(string_concat("Found: ", int_to_string(vector_get(nums, idx)))));
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
