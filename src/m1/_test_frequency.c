...
int64_t count_freq(int64_t nums) {
int64_t _will_0=0,_will_1=0,_will_2=0,_will_3=0,_will_4=0,_will_5=0,_will_6=0,_will_7=0,_will_8=0,_will_9=0;
int64_t m;
int64_t i;
int64_t _;
...
int64_t old;
  int64_t _m1_ret = 0;
  _m1_ret = (m = map_new(), i = 0, _ = ({ while ((i < vector_len(nums))) { num = vector_get(nums, i), old = map_get(m, num), _ = map_set(m, num, (old + 1)), ({ (i = (i + 1)); i; }); } 0; }), m);
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
...
int64_t m;
  int _m1_ret = 0;
  _m1_ret = (nums = vector_new(), _ = vector_push(nums, 1), _ = vector_push(nums, 3), _ = vector_push(nums, 2), _ = vector_push(nums, 1), _ = vector_push(nums, 2), _ = vector_push(nums, 1), m = count_freq(nums), _ = say(string_concat("Unique count: ", int_to_string(map_len(m)))), _ = say(string_concat("1 appears: ", int_to_string(map_get(m, 1)))), _ = say(string_concat("2 appears: ", int_to_string(map_get(m, 2)))), say(string_concat("3 appears: ", int_to_string(map_get(m, 3)))));
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
