...
int64_t _will_0=0,_will_1=0,_will_2=0,_will_3=0,_will_4=0,_will_5=0,_will_6=0,_will_7=0,_will_8=0,_will_9=0;
  int64_t _m1_ret = 0;
  _m1_ret = ({ int64_t balance = initial; ({ int64_t _ = ({ if (!((balance >= 0))) { fprintf(stderr, "H:/AI-Focused_language/tests/module/bank.m1:5:19: error: [M1103] 'now' assertion violated: (invariant)\n"); exit(1); } 0; }); ({ int64_t _ = ({ if ((balance < 100)) { say("low balance"); } 0; }); balance; }); }); });
  goto __m1_return;
__m1_return:
  return _m1_ret;
}
